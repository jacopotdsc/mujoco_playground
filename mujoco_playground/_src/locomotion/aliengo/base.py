...
def get_assets() -> Dict[str, bytes]:
  ...
  assets_dir = consts.ROOT_PATH / "xmls" / "assets"
  mjx_env.update_assets(assets, assets_dir, "*.stl")
  mjx_env.update_assets(assets, assets_dir, "*.xml")
  mjx_env.update_assets(assets, assets_dir)
  return assets


class AliengoEnv(mjx_env.MjxEnv):
  """Base class for Aliengo environments."""
